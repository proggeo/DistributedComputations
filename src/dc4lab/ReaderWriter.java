...
public class ReaderWriter {
    ...
    static String path = "D:\\OneDrive\\$Programming\\DistributedComputations\\src\\dc4lab\\database";
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        Thread reader1 = new Thread(new Reader("556-75-89"));
        Thread reader2 = new Thread(new Reader("Andrew", "Cloyd"));
        writer1.start();
        reader1.start();
        writer2.start();
        reader2.start();
